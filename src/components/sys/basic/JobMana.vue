<template>
  <div>
    <div>
      ...
      <el-button icon="el-icon-plus" @click="addJobLevel" type="primary" size="small">添加</el-button>
    </div>
...
<script>
import {getRequest, putRequest, deleteRequest, postRequest} from "@/utils/api";
